...
class SidebarFrame(customtkinter.CTkFrame):
    ...
    def __init__(self, parentPage, **kwargs):
        ...
        row+=1
        self.sidebar_button_1 = customtkinter.CTkButton(self, text="Booking History", command= lambda : self.change_frame_event("ViewCustomerBookingsFrame"))
        self.sidebar_button_1.grid(row=row, column=0, padx=20, pady=10)
        row+=1
        self.sidebar_button_2 = customtkinter.CTkButton(self,text="New Booking", command= lambda : self.change_frame_event("BookingRegistrationFrame"))
        self.sidebar_button_2.grid(row=row, column=0, padx=20, pady=10)
